...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[]) {
  ...
  for (int prhs_ind=output_tensor_prhs_index; prhs_ind<=input1_tensor_prhs_index; prhs_ind++){
      ...
      size_t** target_indices_full_strides;
	...
	target_indices_full_strides = &output_indices_full_strides;
	...
	target_indices_full_strides = &input0_indices_full_strides;
	...
	target_indices_full_strides = &input1_indices_full_strides;
      }
