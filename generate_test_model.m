function [] = generate_test_model(type)
    if strcmpi(type, 'nmf')
        evalin('base', ['movie_index = Index(177);' ...
    ...
    elseif strcmpi( type, 'tucker3_nmf')
        evalin('base', ['i_index = Index(2);' ...
                        'j_index = Index(3);' ...
                        'k_index = Index(4);' ...
                        'p_index = Index(5);' ...
                        ...
                        'X2.data = rand( i_index.cardinality, j_index.cardinality, k_index.cardinality );' ...
                        'A.data = rand( i_index.cardinality, p_index.cardinality );' ...
                        'B.data = rand( j_index.cardinality, q_index.cardinality );' ...
                        'C.data = rand( k_index.cardinality, r_index.cardinality );' ...
                        'G.data = rand( p_index.cardinality, q_index.cardinality, r_index.cardinality );' ...
                        'Z1.data = rand( i_index.cardinality, k_index.cardinality );' ...
                        'Z2.data = rand( k_index.cardinality, j_index.cardinality );' ...
                        'pre_process();' ...
                        'p = [1];' ...
                        'phi = [1];' ...
                        'factorization_model = {X1, {A, B, C, G}, X2, {Z1, Z2}};']);
    else
